"""
Production settings for CaveAVin project.
"""
...
ALLOWED_HOSTS = [
    ...
    'cellar-production.up.railway.app',  # Your Railway domain
...
CORS_ALLOWED_ORIGINS = [
    ...
    'https://tchin.vercel.app',  # Production frontend
]
...
if DATABASE_URL:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.getenv('DB_NAME', 'caveavin_prod'),
            'USER': os.getenv('DB_USER', 'caveavin_user'),
