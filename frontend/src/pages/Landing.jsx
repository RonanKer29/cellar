...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center gap-4">
              ...
              <Link to="/signup">
                <Button 
                  className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 focus-visible:ring-2 focus-visible:ring-pink-500 focus-visible:ring-offset-2"
                >
            ...
            >
              <div className="flex flex-col gap-3">
                ...
                <Link to="/signup" onClick={() => setIsMobileMenuOpen(false)}>
                  <Button 
                    className="w-full bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 focus-visible:ring-2 focus-visible:ring-pink-500 focus-visible:ring-offset-2"
                  >
                    Essayer Gratuitement
                  </Button>
                </Link>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <Badge className="mb-4 sm:mb-6 bg-pink-100 text-pink-700 hover:bg-pink-200 text-sm sm:text-base">
              <span role="img" aria-label="Verre de vin">🍷</span> La solution #1 pour les amateurs de vin
            </Badge>
      ...
      {/* Features Section */}
      <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-white/50" aria-labelledby="features-heading">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
      ...
      {/* Benefits Section */}
      <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8" aria-labelledby="benefits-heading">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="order-2 lg:order-1">
              <h2 id="benefits-heading" className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Pourquoi choisir{' '}
                <span className="bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">
                  Ma Cave à Vin
                </span> ?
                  ...
                  <div className="space-y-4 sm:space-y-6">
                    <div className="flex items-center gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-xs sm:text-sm text-gray-600">Connaissance de votre collection</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className="bg-gradient-to-r from-pink-600 to-purple-600 p-2 sm:p-3 rounded-full">
                        <Star className="h-4 w-4 sm:h-6 sm:w-6 text-white" aria-hidden="true" />
                      </div>
                      <div>
                        <div className="text-xl sm:text-2xl font-bold text-gray-900">4.9/5</div>
                        <div className="text-xs sm:text-sm text-gray-600">Satisfaction utilisateur</div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3 sm:gap-4">
                      <div className="bg-gradient-to-r from-pink-600 to-purple-600 p-2 sm:p-3 rounded-full">
                        <MapPin className="h-4 w-4 sm:h-6 sm:w-6 text-white" aria-hidden="true" />
                      </div>
                      <div>
                        <div className="text-xl sm:text-2xl font-bold text-gray-900">120+</div>
                        <div className="text-xs sm:text-sm text-gray-600">Régions viticoles couvertes</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
      ...
      {/* CTA Section */}
      <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-pink-600 to-purple-600" aria-labelledby="cta-heading">
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-white py-8 sm:py-12 px-4 sm:px-6 lg:px-8" role="contentinfo">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <div className="bg-gradient-to-r from-pink-600 to-purple-600 p-2 rounded-lg group-hover:shadow-lg transition-all duration-200">
              <Wine className="h-5 w-5 sm:h-6 sm:w-6 text-white" aria-hidden="true" />
            </div>
            <span className="text-lg sm:text-xl font-bold group-hover:text-pink-200 transition-colors">Ma Cave à Vin</span>
          </Link>
          <p className="text-gray-400 mb-4 text-sm sm:text-base">
            La solution professionnelle pour les passionnés de vin
          </p>
          <nav className="flex justify-center gap-6 sm:gap-8 text-sm text-gray-400" aria-label="Navigation du footer">
            <Link 
              to="/login" 
